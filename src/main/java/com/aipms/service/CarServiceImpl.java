...
public class CarServiceImpl implements CarService {
    ...
    public void registerCar(CarDto carDto) {
        ...
        memberMapper.updateCarNumber(carDto.getMemberId(), carDto.getCarNumber());
    }
    ...
    @Override
    public List<CarDto> getCarsByMemberId(Long memberId) {
        List<Car> cars = carMapper.findByMemberId(memberId);
