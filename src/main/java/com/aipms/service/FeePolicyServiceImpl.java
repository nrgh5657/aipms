...
import com.aipms.dto.FeeOverviewDto;
...
public class FeePolicyServiceImpl implements FeePolicyService {
    ...
    @Override
    public FeeOverviewDto getBaseFees() {
        Integer time = feePolicyMapper.selectBaseFeeByType("TIME");
        Integer daily = feePolicyMapper.selectBaseFeeByType("DAILY");
        Integer monthly = feePolicyMapper.selectBaseFeeByType("MONTHLY");
        return new FeeOverviewDto(time, daily, monthly);
    }
}
