...
document.addEventListener('DOMContentLoaded', () => {
    ...
    initializeCommon();
    document.getElementById('reservationCloseBtn')?.addEventListener('click', closeReservationModal);
    document.getElementById('reservationModal')?.addEventListener('click', closeReservationModal);

    document.querySelectorAll('.reservation-modal-content').forEach(el => {
